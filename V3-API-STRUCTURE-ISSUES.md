...
- **V2 Source**: `src/` folder - stable production code
- **V3 Source**: `src3/` folder - development version
- **Key V2 Files**:
...
**V3 Behavior**: `api.multiDefaults.*`, `api.multiFunc.*` (camelCase conversion)

**Status**: ❓ INVESTIGATING

**Notes**:
- Need to check v2 sanitization rules
- Possible breaking change vs intentional improvement?
- Check src/lib/helpers/sanitize.mjs in v2 vs v3
...
**V3 Behavior**: `api.task.autoIp()`, `api.task.parseJson.parseJSON()` (sanitized + over-nested)

**Status**: ✅ UNDERSTOOD - TWO SEPARATE ISSUES
...
**V3 Behavior**: `api.util.getHttpStatus.getHTTPStatus()` (over-nested)

**Status**: ✅ UNDERSTOOD - SAME AS ISSUE 5 PROBLEM 1
