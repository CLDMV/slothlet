 ...
 */
export function mutateLiveBindingFunction(target: object | Function, source: object | Function): void;
/**
 ...
 * @public
 */
export function slothlet(options?: SlothletOptions): Promise<object | Function>;
