 ...
 *	@Filename: /api_tests/api_tv_test/subfolder/state.mjs
...
/**
 * @fileoverview Device state API module for TV Remote subfolder testing.
 * @module api_tv_test.subfolder.state
 * @memberof module:api_tv_test
 */
/**
 * @namespace state
 * @memberof module:api_tv_test.subfolder
 * @alias module:api_tv_test.subfolder.state
 */
/**
 * cloneState.
 * @returns {*}
...
/**
 * setPseudoMuteState.
 * @param {*} pseudoMuted - pseudoMuted.
 * @param {*} [savedVolume] - savedVolume.
 * @returns {*}
 * @example // ESM usage via slothlet API
 * import slothlet from "@cldmv/slothlet";
 * const api_tv_test = await slothlet({ dir: './api_tests/api_tv_test' });
