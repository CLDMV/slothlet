...
| suites/rules/rule-12-comprehensive.test.vitest.mjs | API Rules | ✅ 1st pass (2026-01-28 15:00) | ❌ fail (2026-01-28 15:00) | 4/14 pass, 10 fail - Fixed OWNERSHIP_MATRIX import to use getMatrixConfigs({ collision: { initial: "merge", addApi: "merge" } }) |
...
| suites/context/als-cleanup.test.vitest.mjs | Context Management | ✅ 1st pass (2026-01-28 14:27) | ❌ fail (2026-01-28 14:27) | 4/24 pass, 20 fail - Needs v3 API review, actual test failures |
| suites/context/auto-context-propagation.test.vitest.mjs | Context Management + EventEmitter | ✅ 1st pass (2026-01-28 14:27) | ❌ fail (2026-01-28 14:27) | 0/8 pass, 8 fail - Needs v3 API review, actual test failures - Related to eventemitter-context-propagation.md |
...
| suites/context/per-request-context.test.vitest.mjs | Context Management | ✅ 1st pass (2026-01-28 14:28) | ❌ fail (2026-01-28 14:28) | 0/77 pass, 77 fail - Needs v3 API review, actual test failures |
| suites/context/tcp-context-propagation.test.vitest.mjs | Context Management + EventEmitter | ✅ 1st pass (2026-01-28 14:34) | ❌ fail (2026-01-28 14:34) | 1/1 pass but exit code 1 - Needs investigation - Related to eventemitter-context-propagation.md |
| suites/context/tcp-eventemitter-context.test.vitest.mjs | Context Management + EventEmitter | ✅ 1st pass (2026-01-28 14:34) | ❌ fail (2026-01-28 14:34) | 2/2 pass but exit code 1 - Needs investigation - Related to eventemitter-context-propagation.md |
...
| suites/api-manager/api-manager-allowMutation-disabled.test.vitest.mjs | API Manager + Config | ✅ Yes (2026-01-20 21:30) | ❌ fail (2026-01-28 12:06:50) | 48/96 tests fail, 48 pass - Updated test results |
