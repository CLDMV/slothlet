...
| suites/context/als-cleanup.test.vitest.mjs | Context Management | ✅ 1st pass (2026-01-28 14:27) | ❌ partial (2026-02-17) | 12/24 pass, 12 fail (50%) - Shutdown cleanup and instance isolation tests pass. Reload tests failing - instance IDs not being properly cleaned up after shutdown/reload cycles |
...
| suites/api-manager/api-manager-advanced.test.vitest.mjs | API Manager | ✅ 1st pass (2026-01-28 14:28) | ❌ fail (2026-02-17) | 48/112 pass, 64 fail (43%) - Reference identity issues with reload. Tests expect object references to persist across api.slothlet.api.reload() but objects are being recreated |
...
| suites/api-manager/api-manager-hooks.test.vitest.mjs | API Manager + Hooks | ✅ Yes (2026-01-28 12:52) | ❌ fail (2026-02-17) | 0/8 pass, 8 fail (0%) - Hook registrations not persisting across hot reloads. All tests expect hooks to remain active after reload but hooks are being cleared |
