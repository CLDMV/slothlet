...
| suites/context/als-cleanup.test.vitest.mjs | Context Management | ✅ 1st pass (2026-01-28 14:27) | ❌ fail (2026-01-28 19:20) | 4/24 pass, 20 fail - Needs v3 API review, actual test failures |
| suites/context/auto-context-propagation.test.vitest.mjs | Context Management + EventEmitter | ✅ 1st pass (2026-01-28 14:27) | ❌ fail (2026-01-28 19:20) | 0/8 pass, 8 fail - api.__ctx undefined - Related to docs/v3/todo/eventemitter-context-propagation.md - BLOCKED: EventEmitter ALS patching not implemented |
| suites/context/map-set-proxy-fix.test.vitest.mjs | Context Management | ✅ 1st pass (2026-01-28 14:34) | ❌ fail (2026-01-28 14:34) | 0/16 pass, 16 fail - Actual test failures |
| suites/context/per-request-context.test.vitest.mjs | Context Management | ✅ Implemented (2026-01-28 20:41) | ✅ pass (2026-01-28 20:41) | 77/77 pass (100%) - **FULLY IMPLEMENTED**: api.slothlet.context.run() and api.slothlet.context.scope() with shallow/deep merge support. api.slothlet.context.get(key?) gets context values. Works with both async (ALS) and live contexts. Config validation for scope:false and invalid merge strategies. Context properly propagates through nested calls and API function calls. Tests verify context isolation (base context preserved after .run()). Related: docs/v3/todo/per-request-context-isolation.md marked COMPLETE |
| suites/context/tcp-context-propagation.test.vitest.mjs | Context Management + EventEmitter | ✅ 1st pass (2026-01-28 14:34) | ❌ fail (2026-01-28 19:20) | 1/1 pass but exit code 1 - Worker crash - Related to docs/v3/todo/eventemitter-context-propagation.md - BLOCKED: EventEmitter ALS patching not implemented |
| suites/context/tcp-eventemitter-context.test.vitest.mjs | Context Management + EventEmitter | ✅ 1st pass (2026-01-28 14:34) | ❌ fail (2026-01-28 19:20) | 2/2 pass but exit code 1 - Worker crash - Related to docs/v3/todo/eventemitter-context-propagation.md - BLOCKED: EventEmitter ALS patching not implemented |
...
| suites/hooks/hooks-after-chaining.test.vitest.mjs | Hooks | ✅ Yes (2026-01-28 12:52) | ❌ fail - NOT IMPLEMENTED | Hooks system stubbed - updated API calls from api.hooks.on(type, handler, {pattern, ...}) to api.slothlet.hook.on("type:pattern", handler, {...}) - Related to hooks-system.md |
| suites/hooks/hooks-always-error-context.test.vitest.mjs | Hooks | ✅ Yes (2026-01-28 12:52) | ❌ fail - NOT IMPLEMENTED | Hooks system stubbed - updated API calls to v3 syntax - Related to hooks-system.md |
| suites/hooks/hooks-before-chaining.test.vitest.mjs | Hooks | ✅ Yes (2026-01-28 12:52) | ❌ fail - NOT IMPLEMENTED | Hooks system stubbed - updated API calls to v3 syntax - Related to hooks-system.md |
| suites/hooks/hooks-comprehensive.test.vitest.mjs | Hooks | ✅ Yes (2026-01-28 12:52) | ❌ fail - NOT IMPLEMENTED | Hooks system stubbed - updated API calls to v3 syntax - Related to hooks-system.md |
| suites/hooks/hooks-debug.test.vitest.mjs | Hooks | ✅ Yes (2026-01-28 12:52) | ❌ fail - NOT IMPLEMENTED | Hooks system stubbed - updated API calls to v3 syntax - Related to hooks-system.md |
| suites/hooks/hooks-error-source.test.vitest.mjs | Hooks | ✅ Yes (2026-01-28 12:52) | ❌ fail - NOT IMPLEMENTED | Hooks system stubbed - updated API calls to v3 syntax - Related to hooks-system.md |
| suites/hooks/hooks-execution.test.vitest.mjs | Hooks | ✅ Yes (2026-01-28 12:52) | ❌ fail - NOT IMPLEMENTED | Hooks system stubbed - updated API calls to v3 syntax - Related to hooks-system.md |
| suites/hooks/hooks-internal-properties.test.vitest.mjs | Hooks | ✅ Yes (2026-01-28 12:52) | ❌ fail - NOT IMPLEMENTED | Hooks system stubbed - updated API calls to v3 syntax - Related to hooks-system.md |
| suites/hooks/hooks-mixed-scenarios.test.vitest.mjs | Hooks | ✅ Yes (2026-01-28 12:52) | ❌ fail - NOT IMPLEMENTED | Hooks system stubbed - updated API calls to v3 syntax - Related to hooks-system.md |
| suites/hooks/hooks-patterns.test.vitest.mjs | Hooks | ✅ Yes (2026-01-28 12:52) | ❌ fail - NOT IMPLEMENTED | Hooks system stubbed - updated API calls to v3 syntax - Related to hooks-system.md |
| suites/hooks/hooks-short-circuit.test.vitest.mjs | Hooks | ✅ Yes (2026-01-28 12:52) | ❌ fail - NOT IMPLEMENTED | Hooks system stubbed - updated API calls to v3 syntax - Related to hooks-system.md |
| suites/hooks/hooks-suppress-errors.test.vitest.mjs | Hooks | ✅ Yes (2026-01-28 12:52) | ❌ fail - NOT IMPLEMENTED | Hooks system stubbed - updated API calls to v3 syntax - Related to hooks-system.md |
| suites/hooks/hook-subsets.test.vitest.mjs | Hooks | ✅ Yes (2026-01-28 12:52) | ❌ fail - NOT IMPLEMENTED | Hooks system stubbed - updated API calls to v3 syntax - Related to hooks-system.md |
