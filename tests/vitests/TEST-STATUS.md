...
| suites/api/eager/api-eager-basic.test.vitest.mjs | Core API | ✅ Yes (2026-02-14) | ✅ pass (2026-02-14 23:21) | 44/44 pass (100%) - Fixed eager mode collision handling for named exports vs default properties |
| suites/api/eager/api-eager-hooks.test.vitest.mjs | Core API + Hooks | ✅ Yes (2026-02-14) | ✅ pass (2026-02-14 23:21) | 44/44 pass (100%) - Fixed eager mode collision handling for named exports vs default properties |
| suites/api/eager/api-eager-hot.test.vitest.mjs | Core API + API Manager | ✅ Yes (2026-02-14) | ✅ pass (2026-02-14 23:42) | 88/88 pass (100%) - Fixed collision config and shared expectation |
| suites/api/eager/api-eager-live.test.vitest.mjs | Core API + Live Binding | ✅ Yes (2026-02-14) | ✅ pass (2026-02-14 23:42) | 88/88 pass (100%) - Fixed collision config and shared expectation |
...
| suites/api/lazy/api-lazy-basic.test.vitest.mjs | Core API | ✅ Yes (2026-02-14) | ✅ pass (2026-02-14 23:21) | 44/44 pass (100%) - All tests pass with v3 collision config |
...
| suites/api/lazy/api-lazy-hooks.test.vitest.mjs | Core API + Hooks | ✅ Yes (2026-02-14) | ✅ pass (2026-02-14 23:21) | 44/44 pass (100%) - All tests pass with v3 collision config |
| suites/api/lazy/api-lazy-hot.test.vitest.mjs | Core API + API Manager | ✅ Yes (2026-02-14) | ✅ pass (2026-02-14 23:42) | 88/88 pass (100%) - Fixed collision config and shared expectation |
| suites/api/lazy/api-lazy-live.test.vitest.mjs | Core API + Live Binding | ✅ Yes (2026-02-14) | ✅ pass (2026-02-14 23:42) | 88/88 pass (100%) - Fixed collision config and shared expectation |
| suites/api-structures/all-api-structures.test.vitest.mjs | Core API | ✅ Yes (2026-02-14) | ❌ partial (2026-02-14 22:22) | 38/42 pass (90%) - 4 failures in structure validation |
...
| suites/context/als-cleanup.test.vitest.mjs | Context Management | ✅ 1st pass (2026-01-28 14:27) | ❌ partial (2026-02-14 21:44) | 12/24 pass (50%) - **V3 API UPDATED**: Changed api.__ctx to api.slothlet.context.diagnostics(). 12 tests pass. 12 reload-related tests still failing (not mutation disabled - different issue) |
...
| suites/core/core-reload-full.test.vitest.mjs | Core API + API Manager | ✅ Yes (2026-02-14) | ✅ pass (2026-02-14 21:43) | 56/56 tests pass - Full reload with operation history replay |
| suites/core/core-reload-lazy-mode.test.vitest.mjs | Core API + API Manager | ✅ Yes (2026-02-14) | ✅ pass (2026-02-14 21:43) | 68/68 tests pass - Lazy mode reload verification |
| suites/core/core-reload-path-multicache.test.vitest.mjs | Core API + API Manager | ✅ Yes (2026-02-14) | ✅ pass (2026-02-14 21:43) | 112/112 tests pass - Path-based reload with multi-cache handling |
| suites/core/core-reload-selective.test.vitest.mjs | Core API + API Manager | ✅ Yes (2026-02-14) | ✅ pass (2026-02-14 21:43) | 56/56 tests pass - Selective path reload operations |
...
| suites/api-manager/api-manager-basic.test.vitest.mjs | API Manager Basic | ✅ Yes (2026-02-14) | ❌ partial (2026-02-14 22:22) | 104/112 pass (93%) - 8 reload tests failing with collision issues (expecting 5, getting 1005) |
| suites/api-manager/api-manager-errors.test.vitest.mjs | API Manager + Error Handling | ✅ Yes (2026-02-14) | ❌ partial (2026-02-14 22:22) | 1/5 pass (20%) - 4 error handling tests failing |
| suites/api-manager/api-manager-hooks.test.vitest.mjs | API Manager + Hooks | ✅ Yes (2026-02-14) | ❌ fail (2026-02-14 22:22) | 0/8 pass - Fixed v3 config format (hooks→hook.enabled), all tests now failing |
| suites/api-manager/api-manager-reference-identity.test.vitest.mjs | API Manager + Reference Identity | ✅ Yes (2026-02-14) | ❌ partial (2026-02-14 22:22) | 16/80 pass (20%) - 64 reference identity tests failing |
| suites/api-manager/api-manager-test-remove-reload-isolated.test.vitest.mjs | API Manager + Remove/Reload | ✅ Yes (2026-02-14) | ✅ pass (2026-02-14 22:22) | 16/16 pass (100%) - All isolated remove/reload tests passing |
