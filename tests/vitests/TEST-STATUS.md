...
| suites/hooks/hooks-patterns.test.vitest.mjs | Hooks | ✅ Yes (2026-01-29 22:12) | ❌ fail (2026-01-29 22:12) | 40/61 pass, 21 fail - **CORE FAILURES**: (1) Brace expansion patterns not matching anything (2) Negation patterns not working (3) Nested brace expansion not expanding (4) Maximum nesting depth validation not throwing errors (5) list() returns array instead of object with registeredHooks property (6) Pattern matching with apiDepth not triggering hooks |
...
| suites/hooks/hook-subsets.test.vitest.mjs | Hooks | ✅ Yes (2026-01-29 22:12) | ❌ fail (2026-01-29 22:12) | 64/92 pass, 28 fail - Updated __ctx console.log. **CORE FAILURES**: (1) Hook priority ordering within subsets not working (expects before-high, before-low but getting before-high, primary-high) (2) list() returning array instead of object with registeredHooks property (3) Error type not being captured in error hooks (4) Invalid subset validation not throwing correct error |
