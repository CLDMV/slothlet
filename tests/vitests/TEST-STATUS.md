...
| suites/api/eager/api-eager-hot.test.vitest.mjs | Core API + API Manager | ✅ Yes (2026-02-14) | ❌ partial (2026-02-14 21:51) | 84/88 pass (95%) - 4 failures in API manager tests |
| suites/api/eager/api-eager-live.test.vitest.mjs | Core API + Live Binding | ✅ Yes (2026-02-14) | ❌ partial (2026-02-14 21:51) | 84/88 pass (95%) - 4 failures in live binding tests |
...
| suites/api/lazy/api-lazy-hot.test.vitest.mjs | Core API + API Manager | ✅ Yes (2026-02-14) | ❌ partial (2026-02-14 21:51) | 84/88 pass (95%) - 4 failures in API manager tests |
| suites/api/lazy/api-lazy-live.test.vitest.mjs | Core API + Live Binding | ✅ Yes (2026-02-14) | ❌ partial (2026-02-14 21:51) | 84/88 pass (95%) - 4 failures in live binding tests |
