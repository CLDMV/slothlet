 ...
 *	@Filename: /tests/vitests/run-all-vitest2.mjs
 ...
 * @module tests/vitests/run-all-vitest2
 * @internal
 *
 * @description
 ...
 *
 * @example
 * node tests/vitests/run-all-vitest2.mjs --baseline
 *
 * @example
 * node tests/vitests/run-all-vitest2.mjs suites/config/background-materialize.test.vitest.mjs
 */
...
EXAMPLES:
  node tests/vitests/run-all-vitest2.mjs --baseline
  node tests/vitests/run-all-vitest2.mjs suites/config/background-materialize.test.vitest.mjs
  node tests/vitests/run-all-vitest2.mjs --workers 2 suites/context
  node tests/vitests/run-all-vitest2.mjs -t "lazy materialization"
`);
}
...
function parseArguments(args) {
	...
	let testFilePattern;
	let logFile;
	const earlyRunPatterns = [...EARLY_RUN_PATTERNS];
	const vitestArgs = [];
	const testPatterns = [];
