...
async function runAllTests() {
	...
	try {
		...
		await runTest(path.join(__dirname, "test-cjs-entry.cjs"), "CommonJS Entry Point Test");

		// Test ESM entry point
		await runTest(path.join(__dirname, "test-esm-entry.mjs"), "ESM Entry Point Test");
