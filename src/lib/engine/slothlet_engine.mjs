...
/**
 * VM backend implementation using vm context.
 * @param {string} entry - Entry point URL
 * @param {object} loadConfig - Load configuration
 * @param {object} ctxRef - Context and reference objects
 * @returns {Promise<object>} VM backend instance
 * @private
 */
