 ...
 * @public
 */
export function getSafeFunctionName(name, fallback) {
 ...
 * @public
 */
export function ensureNamedExportFunction(fn, nameHint) {
 ...
 * @public
 */
export function createNamedMaterializeFunc(apiPath, handler) {
 ...
 * @public
 */
export function cloneWrapperImpl(value, mode) {
	if (mode !== "eager") {
		return value;
	}
 ...
 * @public
 */
export function getOwnershipCollisionMode(config, collisionContext = "initial") {
