...
export function sanitizePropertyName(input, options = {}) {
	const instance = new Sanitize();
	return instance.sanitizePropertyName(input, options);
}
...
export function getModuleId(filePath, baseDir) {
	const instance = new Sanitize();
	return instance.getModuleId(filePath, baseDir);
}
...
export function shouldPreserveFunctionCase(name) {
	const instance = new Sanitize();
	return instance.shouldPreserveFunctionCase(name);
}
