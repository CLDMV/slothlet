 ...
 * @property {object} slothlet.versioning - Runtime version management API. Available when at least one module has been registered via `api.slothlet.api.add()` with a `versionConfig` argument.
