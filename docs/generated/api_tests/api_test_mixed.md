...
> <p>This module provides test objects and functions for validating slothlet's API loading capabilities with mixed ESM and CJS modules. It includes both ESM and CJS math operations and cross-module interoperability tests using slothlet's runtime self-reference feature.</p>
> 
