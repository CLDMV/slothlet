...
```javascript
// Throws: rule.condition must be a plain object, a function, or an array of plain objects and functions
...
// Also throws: array containing a non-object/non-function entry
...
- `PERM_RULE_CONDITION_INVALID`: `"rule.condition must be a plain object, a function, or an array of plain objects and functions"`
