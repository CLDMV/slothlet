...
| Timers / microtasks (`setTimeout`, `setInterval`, `setImmediate`, `queueMicrotask`, `process.nextTick`, `requestAnimationFrame`) | not needed — AsyncLocalStorage already spans them                                         | needed                                             |
